...
public class activity_moyen extends AppCompatActivity {
    ...
    private int onClick(ProgressBar p, TextView o, TextView a1, TextView a2, TextView a3, TextView a4){
        ...
        int res = 0;
        if (p.getProgress() == 5){
            Intent i = new Intent(activity_moyen.this,Score.class);
    ...
    private int[] gOperation(TextView T){
        ...
        int random_operation2 = gRandom(4);
        int random_x1 = gRandom(30)+15;
        int random_x2 = gRandom(30)+15;
        int res;
        if(random_operation2 == 0){
            random_x1 = -random_x1;
        }
